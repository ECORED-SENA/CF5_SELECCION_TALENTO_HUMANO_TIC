  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bg2  
      ...
      .row.justify-content-center.align-items-stretch.mt-5
        .col-lg-4.my-3
          .tarjeta--boton.color-primario.p-5(data-aos="fade-left")
        ...
        .col-lg-4.my-3
          .tarjeta--boton.color-primario(@mouseover="indicadorTarjetaFlip = false").p-5(data-aos="fade-down")
        ...
        .col-lg-4.my-3
          .tarjeta--boton.color-primario.p-5(data-aos="fade-right")
            .row.justify-content-center.mb-3
              .col-7
            ...
            .col-md-9
              SlyderF(columnas="col-12")
                ...
                .tarjeta.color-acento-botones.p-4
                  ...
                  h5.text-center Multinacionales
